...
class MonitorConfig:
    ...
    CLOSED_TIME_LIMIT: float = 0.8       # Fast alert: 0.8 seconds of closed eyes triggers alert
    SPEECH_COOLDOWN: float = 2.0         # Minimum seconds between repeated voice alerts
